...
/**
 * StarterBar 右サイズダイアログ
 * @author ku
 */
public class SettingParamsDialogSizeStarterBarRight extends DialogFragment {
  private static final String TAG = "SettingParamsDialogSizeStarterBarRight";
  ...
  public SettingParamsDialogSizeStarterBarRight(Context context, LayoutInflater layoutInflater) {
  ...
  public Dialog onCreateDialog(Bundle savedInstanceState) {
    ...
    builder.setTitle(context.getString(R.string.setting_starterbar_right_size_pos));
    ...
    // 幅の設定
    barWidthSb.setProgress(parameterManager.getStarterBarWidthRight());
    ...
    barWidth.setText(String.valueOf(parameterManager.getStarterBarWidthRight()));
    ...
    // 高さの設定
    barHeightSb.setProgress(parameterManager.getStarterBarHeightRight());
    ...
    // 位置の設定
    barPositionSb.setProgress(parameterManager.getStarterBarPositionRight());
    ...
    builder.setPositiveButton(getString(R.string.setting_apply), new DialogInterface.OnClickListener() {
      public void onClick(DialogInterface dialog, int id) {
        ...
        // バーの幅を保存
        parameterManager.putStarterBarWidthRight(Integer.parseInt(barWidth.getText().toString()));
        
        // バーの高さを保存
        parameterManager.putStarterBarHeightRight(Integer.parseInt(barHeight.getText().toString()));
        
        // バーの位置を保存
        parameterManager.putStarterBarPositionRight(Integer.parseInt(barPosition.getText().toString()));
  ...
  private void redrawRightBar() {
    if (appsLauncherService != null) {
      appsLauncherService.redrawRightBar(barWidthSb.getProgress(), barHeightSb.getProgress(), parameterManager.getStarterBarColor(), barPositionSb.getProgress());
    }
  }
